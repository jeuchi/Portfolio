...
export default function () {
    ...
    const p1Sequence = new ScrollSequence({
        container: '.project-1-sequence',
        scrollWith: '.project-1-container',
        images: p1SequenceImages,
        imagesRoot: 'https://raw.githubusercontent.com/jeuchi/media/main/FireflyDemo/',
    ...
    const p2Sequence = new ScrollSequence({
